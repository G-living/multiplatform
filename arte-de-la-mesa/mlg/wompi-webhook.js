// wompi-webhook.js
// Cloudflare Worker — Recibe confirmaciones de pago de Wompi y actualiza Google Sheets (MLG)
// Deploy: cd arte-de-la-mesa/mlg && npx wrangler deploy --config wrangler-webhook.toml
// Secrets: npx wrangler secret put WOMPI_EVENTS_SECRET --config wrangler-webhook.toml
//          npx wrangler secret put GOOGLE_SHEETS_WEBHOOK_URL --config wrangler-webhook.toml
//          npx wrangler secret put GAS_API_TOKEN --config wrangler-webhook.toml
...
/**
 * Llama al GAS de MLG para confirmar el pago Wompi en Google Sheets
 */
